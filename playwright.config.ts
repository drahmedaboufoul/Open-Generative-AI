...
// with E2E_BASE_URL; otherwise it starts the app itself on 4336.
...
export default defineConfig({
  ...
  testMatch: "**/*.e2e.ts",
  outputDir: path.join(os.tmpdir(), "open-generative-ai-playwright"),
  fullyParallel: false,
  workers: 1,
  reporter: "line",
  timeout: 60_000,
  ...
  ...(externalBaseURL
    ...
    : {
        webServer: {
          command: `npm exec -- next dev --hostname 127.0.0.1 --port ${port}`,
          url: `${baseURL}/`,
